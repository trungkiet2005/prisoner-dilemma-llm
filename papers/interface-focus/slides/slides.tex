...
\subtitle{Cooperation Without Reciprocity Across Languages \quad\textcolor{mgray}{\small Royal Society Interface Focus}}
...
\begin{frame}{Thuật Ngữ Trọng Tâm}
  ...
  \begin{enumerate}\small\setlength\itemsep{0.7em}
    ...
    \item \textbf{\color{mprimary}Cooperation Without Reciprocity:} Hiện tượng LLM duy trì hợp tác thụ động ngay cả khi bị đối phương liên tục khai thác và phản bội.
  \end{enumerate}
\end{frame}
...
\begin{itemize}\small\setlength\itemsep{4pt}
  ...
  \item[\textcolor{mgood}{\textbf{\cmark}}]
    \textbf{Về Nhận thức:} Phơi bày cơ chế đối lập giữa "tiền lẻ vi mô" (play money) và "tiền nguyên rủi ro".
  \item[\textcolor{mgood}{\textbf{\cmark}}]
...
“Frontier language models violate payoff-scale invariance and cooperate without reciprocity across languages.”
\end{mdframed}
