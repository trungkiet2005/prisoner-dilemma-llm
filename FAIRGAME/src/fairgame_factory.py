...
from FAIRGAME.src.fairgame import FairGame
from FAIRGAME.src.agent import Agent
from FAIRGAME.src.io_managers.io_manager import IoManager
...
class FairGameFactory:
    ...
    def run_games_batched(self, batch_size=0, max_strategy_retries=2):
        ...
        """
        from FAIRGAME.src.batch_runner import run_games_batched as _run_batched
